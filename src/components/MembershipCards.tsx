      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Choose your path to luxury wellness. Each plan is crafted to deliver 
            exceptional value and exclusive experiences.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {membershipPlans.map((plan, index) => (
            ...
            >
              ...
              {/* Card Container */}
              <div className={`relative h-full bg-gray-900/80 backdrop-blur-sm border-2 rounded-3xl overflow-hidden transition-all duration-500 hover:scale-105 ${
                plan.borderColor
                ...
                <div className="p-8">
                  ...
                  {/* CTA Button */}
                  <button className={`w-full py-4 px-6 rounded-xl font-semibold text-white transition-all duration-300 bg-gradient-to-r ${plan.color} hover:shadow-lg hover:scale-105 ${
                ...
                {/* Glow Effect */}
                <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-gradient-to-br ${plan.color} pointer-events-none`}></div>
                
                {/* Border Glow */}
                <div className={`absolute -inset-0.5 opacity-0 group-hover:opacity-30 transition-opacity duration-500 bg-gradient-to-br ${plan.color} rounded-3xl blur-sm -z-10`}></div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className={`mt-16 text-center transition-all duration-1000 delay-700 ${
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-8 max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Join Crown Wellness Club as a founding member and receive 20% off your first 3 months. 
              Plus, enjoy complimentary personal training sessions and exclusive access to our grand opening events.
            </p>
