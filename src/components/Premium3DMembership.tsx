      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="inline-flex items-center bg-crown-dark-red/20 border border-crown-dark-red/40 rounded-full px-8 py-3 backdrop-blur-sm">
            ...
            <span className="text-crown-white font-semibold text-lg">
              {t("membership.founding_offer")}
            </span>
          </div>
        </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-6">
                      ...
                      {plan.popular && (
                        <Star className="w-8 h-8 text-crown-complementary fill-current" />
                      )}
                    </div>
                    ...
                    <p className="text-crown-white/90 text-sm leading-relaxed">
                      {plan.description}
                    </p>
                  </div>
          ...
          <div className="bg-gradient-to-r from-crown-dark/80 to-crown-dark/80 border border-crown-dark rounded-3xl p-12 max-w-6xl mx-auto backdrop-blur-xl">
            <div className="text-center">
              ...
              <h3 className="text-4xl font-bold text-crown-primary mb-6">
                ...
                <span className="text-crown-primary">
                  {t("membership.guarantee_highlight")}
                </span>
              </h3>
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                <div className="text-center">
                  <div className="text-3xl font-bold text-crown-primary mb-2">
                    25%
                  </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-crown-white">
