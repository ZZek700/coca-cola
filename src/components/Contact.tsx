...
const Contact = () => {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-20 bg-crown-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 max-w-7xl mx-auto">
          ...
          <div className={`transition-all duration-1000 delay-200 ${
            ...
            <div>
              ...
              <p className="text-crown-complementary text-sm mt-4">
          ...
          <div className={`transition-all duration-1000 delay-400 ${
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm shadow-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <p className="text-crown-complementary text-xs text-center">
        ...
        {/* Footer */}
        <div className={`mt-20 pt-12 border-t border-gray-700 text-center transition-all duration-1000 delay-600 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}>
  ...
  />
  <span className="text-crown-white font-semibold text-lg">Crown Wellness Club</span></div>
            
            <p className="text-crown-complementary text-sm">
              {t('contact.footer_text')}
            </p>
            
            <div className="flex items-center space-x-6 text-crown-complementary text-sm">
              <a href="#" className="hover:text-crown-primary transition-colors duration-300">{t('contact.footer_links.privacy')}</a>
              <a href="#" className="hover:text-crown-primary transition-colors duration-300">{t('contact.footer_links.terms')}</a>
              <a href="#" className="hover:text-crown-primary transition-colors duration-300">{t('contact.footer_links.support')}</a>
            </div>
          </div>
        </div>
      </div>
